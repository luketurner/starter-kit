###
  ...
  State is represented as an Immutable object. This object is hidden from view because the semantics of immutability
  make setting module.exports = Immutable.Map(), for example, to be problematic because it cannot be reassigned outside
  this file.

  Instead, State access is mediated with Cursors, which are persistent "pointers" to specific parts of a nested
